...
public static class ResourceDB
{
	public static class Sounds
	{
		...
		public static readonly AudioStream Bigchomp = Load<AudioStream>("res://sounds/bigchomp.ogg");
		public static readonly AudioStream Thump = Load<AudioStream>("res://sounds/gargantuar_thump.ogg");
		public static readonly AudioStream Hmm = Load<AudioStream>("res://sounds/squash_hmm.ogg");
